                ...
                <div className={styles.working}>
                    ...
                    <AnimationWrapper>
                        <div >
                            ...
                            {isAuth && (<div>
                                <p className={styles.texts} >*NOTE* Thank you! You will need to be redirected to the spotify website in order to obtain your credentials, you will be redirected back to us once you're done!</p>
